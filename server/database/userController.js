...
module.exports = {
  postUser(req, res, next) {
    const queryString =
      'INSERT INTO users (pwd, name, apt_id, role) VALUES ($1, $2, $3, $4) RETURNING _id';
    const values = [
      req.body.pwd,
      req.body.name,
      req.body['apt_id'],
  ...
  postEvent(req, res, next) {
    const queryString =
      'INSERT INTO events (date, description, type, resident_id) VALUES ($1, $2, $3, $4) RETURNING description';
    const values = [
      req.body.date,
  ...
  getEvent(req, res, next) {
    ...
    if (req.headers.role === 'Manager') {
      ...
      queryString =
        'SELECT * FROM events WHERE (resident_id = -1 OR resident_id IS NULL OR resident_id = $1)';
  ...
  postMessages(req, res, next) {
    let queryString =
      'INSERT INTO messages (text, sender_id, receiver_id, timestamp) VALUES ($1, $2, $3, $4) RETURNING *';
    let values = [
      req.body.text,
      req.body.sender_id,
